...
##@TTOMIN###
##@ForBaha###
$API_KEY = "5895798458:AAEVOijsBubyd-cjrtuX64IlYP5DXre46w4"; // التوكن البوت
$baha = array("5340950052"); //ايدي المطور 
flush();
ob_start();
set_time_limit(0);
error_reporting(0);
...
if( !in_array($from_id,$baha) && !in_array($from_id,$bahaeloper)){
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"
💯¦ مـرحبا اسمي $namebot Miss
